...
yp_train = [int(round(probs_traini)) for probs_traini in probs_train]
print(tabulate(list(zip(probs_train, yp_train, y_train)), 
                headers=['Probability', 'Predicted Class', 'Actual Class'],
                tablefmt='fancy_grid'))
print('--Testing--\n')
probs_test = glm.predict(logr.logistic, scaledX_test, h_thetaf)
yp_test = [int(round(probs_testi)) for probs_testi in probs_test]
print(tabulate(list(zip(probs_test, yp_test, y_test)), 
                headers=['Probablity', 'Predicted Class', 'Actual Class'],
                tablefmt='fancy_grid'))
pns = metrics.scores(y_test, yp_test)
tp, fp, fn, tn = pns
print('True Positives\t', tp)
print('False Positives\t', fp)
print('False Negatives\t', fn)
print('True Negatives\t', tn)
print('Precision: ', metrics.precision(*pns))
print('Recall: ', metrics.recall(*pns))
